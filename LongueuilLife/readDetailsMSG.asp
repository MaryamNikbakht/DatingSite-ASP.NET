...
<%
    ...
    var sql = "SELECT * FROM Messeges WHERE RefMessage="+MsgId;
    ...
    var sql3 = "SELECT FirstName, LastName From Members WHERE refMember=" + refM;
    var recMemb = new ActiveXObject("ADODB.Recordset");
    recMemb.Open(sql3, mycon);

    var sql4 = "UPDATE Messeges SET [New]=No WHERE RefMessage=" + MsgId;
    var updMsg = new ActiveXObject("ADODB.Recordset");
    mycon.Execute(sql4);
                            ...
                            <form action="#" method="get" style="height: 240px">
                                    ...
                                    <!-- <div class="displayProfile" style="width: 426px">-->
										...
										<span class="auto-style3">Your Messages</span></h2>
                                         ...
                                         <table class="auto-style1" style="width: 690px; height: 121px" cellpadding="5">
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    <%= recMemb.Fields("FirstName").value %>&nbsp;<%= recMemb.Fields("LastName").value %>
                                                </td>
                                                <td >
                                             ...
                                             <tr>
                                                 <td colspan="3">
                                                      <h5> <a href="ReadMessage.asp?MsgID=<%= MsgId%>"> Return to Inbox </a></h5>        
                                                 </td>
