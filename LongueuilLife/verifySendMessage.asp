...
<%
    ...
    var title = Request.QueryString("txtSubject");
    var msg = Request.QueryString("txtareaMsg");
    var send = Session("refSender");
    var recieve = Request.QueryString("txtemailTo");
    //var date = Date.now();
    ...
    var sql = "INSERT INTO Messeges(Title,Message,sender,Reciever) VALUES('" + title + "','" + msg + "'," + send + "," + recieve + ")";
     // var sql = "INSERT INTO Messeges(Title,Message,sender,Reciever) VALUES('test6','Testing subject6',1,2)";
    ...
    //Session("SendMSG") = "Message sent successfuly!";
