...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!--      <script>
            function ShowSecurityQ() {
                document.getElementById('MySecurityQ').style.display = 'block';
            }
        </script>-->

   <!--     $(document).ready() {
             $("div#MySecurityQ").hide();
            }-->
    </head>
    <body>
            ...
            <div class="container bg-white">
                <div class="row-fluid">
                    <div class="block">
                        <div class="formBody">
                            <form action="MyProfile.asp" method="get">
                                     ...
                                     <div class="textboxField ">
                                         ...
                                         <h2>Log in</h2><br />
                                           ...
                                           <p style="color:red;"><%= Session("MSGLogin") %></p>
                                      <!--   <p>User name</p>-->

                                         <input id="txtEmail" name="txtEmail" type="text" class="userInput" placeholder="Email" required>
                                     <!--     <p>Password</p>-->

                                         <input id="txtassword" name="txtPassword" type="password" class="userInput" placeholder="Password" required><br />
                                         

                                         <input type="submit" class="btn btn-danger" value="Log in">
                                         <input type="button" class="btn btn-danger" value="Sign up" onclick="window.location.href='signup1.asp'" /><br /><br /><br />

                                         <a href="forgotPassword.asp" style="font:small" >forget password?</a>
                                      <!--<!--  <!--Security Question-->
