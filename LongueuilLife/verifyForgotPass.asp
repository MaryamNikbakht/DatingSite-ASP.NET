...
<%
    ...
    var sql = "SELECT Email,[Password],SecQuestion,SecAwnser FROM Members WHERE Email='" + email + "' AND SecQuestion='" + secQ + "' AND SecAwnser='" + secAwnser + "'";
    ...
    var pas = (myRec.Fields("Password").value).ToString();
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
            ...
            <div class="container bg-white">
                <div class="row-fluid">
                    <div class="block">
                        <div style="align-content:center; width:50%; line-height:initial; text-align:left; padding-left:100px;">
                            <br />
                            <h5>Your password is : <%= myRec.Fields("Password").value %></h5>
                           </div>
                         <%
                             myRec.Close();
                             mycon.Close();
