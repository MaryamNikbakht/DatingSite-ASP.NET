...
<%
    ...
    var MemId=parseInt(Request.QueryString("MsgID"));
    ...
    var sql = "SELECT * FROM Messeges WHERE Reciever="+MemId;
    ...
    var refM = myrec.Fields("sender").value;
    var sql4 = "SELECT FirstName, LastName From Members WHERE refMember=" + refM;
    var recMemb = new ActiveXObject("ADODB.Recordset");
    recMemb.Open(sql4, mycon);
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
            ...
            <div class="container bg-white">
                <div class="row-fluid">
                    <div class="block" style="height: 569px">
                        <div class="formBody">
                            <form action="#" method="get" style="height: 240px">
										...
										<span class="auto-style3">Your Messages</span></h2>
                                         ...
                                         <table class="auto-style1" style="width: 690px; height: 243px" cellpadding="5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >
                                                             <%= myrec.Fields("CreateDate").value %>
                                                            
                                                        </td>
                                                        <td >
                                                            <a href="readDetailsMSG.asp?refMs=<%= myrec.Fields("RefMessage").value %>">Read</a>&nbsp;&nbsp;
                                                            <a href="deleteMSG.asp?refMs=<%= myrec.Fields("RefMessage").value %>">Delete</a>
                                                        </td>
